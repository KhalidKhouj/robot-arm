/*
Hello my name is Khaled Khouj
This is the servo circuit code
*/
...
void loop() {
  ...
  int pot1Angle = map(pot1Value, 0, 1023, 0, 90); // Map the values of potentiometers (0-1023) to angles that the servo can read (0-179 degrees)
  int pot2Angle = map(pot2Value, 0, 1023, 0, 90);
